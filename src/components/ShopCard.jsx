    ...
    >
      <div className='w-full h-[180px] md:h-[200px] rounded-[1.5rem] overflow-hidden mb-3 relative shadow-sm'>
        ...
        <div className="absolute bottom-3 left-4 flex flex-col">
          <span className="text-white font-black text-xl tracking-tighter drop-shadow-md">ITEMS AT Rs.99</span>
          <span className="text-white/90 font-bold text-sm drop-shadow-md">Up to 20% OFF</span>
        </div>
      </div>
      <div className='px-2'>
